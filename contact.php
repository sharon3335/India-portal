                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                           ...
                           <!-- <li><a class="color_animation" href="#pricing">PRICING</a></li>
							...
							<li><a class="color_animation" href="1.php">WORLD TOUR?</a></li>
                    </div><!-- /.navbar-collapse -->
                </div>
            </div><!-- /.container-fluid -->
        </nav>
        ...
        <div id="top" class="starter_container bg">
            <div class="follow_container">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <h2 class="top-title">India Portal</h2>
                    <h2 class="white second-title">" The Complete Tourist Guide in India"</h2>
                    <hr>
                </div>
...
<!--
     ...
     <!--   <section  id="reservation"  class="description_content">
            ...
            <div class="text-content container"> 
                <div class="col-md-6">
                    ...
                    <ul class="social_icons">
                        <li><a class="icon-twitter color_animation" href="https://twitter.com/sharonau2963" target="_blank"></a></li>
                        <li><a class="icon-github color_animation" href="https://github.com/sharon3335" target="_blank"></a></li>
                        <li><a class="icon-linkedin color_animation" href="https://www.linkedin.com/in/sharon-augustine-08b076157/" target="_blank"></a></li>
                        <li><a class="icon-mail color_animation" href="https://plus.google.com/u/0/117049948611983874302"></a></li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <span class="social_heading">OR DIAL</span>
                    <span class="social_info"><a class="color_animation" href="tel:883-335-6524">+918281526518</a></span>
                </div>
            </div>
        </section>
        ...
        <section id="contact">
            <div class="map">
                <iframe src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJcZNFHAPMBzsR2w3N5OHSX7U&key=AIzaSyBTnzwkq9cf0UiZcSU1T7iAfB0rYZilQC4" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
